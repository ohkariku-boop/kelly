    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1 max-w-3xl mx-auto px-6 py-12">
        ...
        <p className="text-zinc-600 leading-relaxed mb-6">
          Linear has structured project updates. Kelly uses a simple template for
          product managers: progress, risks, next steps, and asks, plus a health
          signal (on track / at risk / off track).
        </p>
        <p className="text-zinc-600 text-sm leading-relaxed mb-6">
          The goal is not another document system. It is a repeatable, short
          narrative tied to the same board leadership already uses.
        </p>
        ...
        <ul className="text-zinc-600 text-sm space-y-2 mb-6">
          ...
          <li>Ad-hoc when health moves to at risk or off track</li>
        </ul>
        <p className="text-zinc-500 text-sm">
          UI for composing updates from the live board is still on the product
          roadmap; the data model already supports stored updates.
        </p>
