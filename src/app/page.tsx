...
export default function Home() {
 ...
 A shared Now / Next / Later board for product priorities. Leadership,
 eng, and design see the same answers each week: what we are advancing,
 what is queued, and what we are putting off on purpose.
 </p>
 <ul className="mt-6 space-y-2 text-sm text-zinc-600">
 <li className="flex gap-2">
 <span className="text-zinc-400">→</span>
 Defend priorities with customer evidence on the work itself
 </li>
 <li className="flex gap-2">
 <span className="text-zinc-400">→</span>
 Keep the team aligned without turning Kelly into another Jira
 </li>
 <li className="flex gap-2">
 <span className="text-zinc-400">→</span>
 Tie roadmap bets to outcomes without forcing an OKR cascade
 </li>
 </ul>
 ...
 <p>
 For more than twenty years I have worked as an IT project manager
 and product manager, stuck between engineering trackers, executive
 decks, and the same weekly question: <em>what should we do now,
 what comes next, and what can wait?</em>
 </p>
 <p>
 The tools never matched the job. Jira and Linear are strong at
 delivery: issues, sprints, velocity. Strategy and OKR tools are
 strong at writing goals on paper. The actual PM work sits in the
 gap: pick a short list of bets, back them with customer evidence,
 keep the team aligned, and give leadership a clear picture without
 rebuilding slides every week. That gap was always filled with
 spreadsheets, Slack threads, and status meetings that existed only
 because the system of record could not tell the story.
 </p>
 <p>
 Kelly is built for that gap. Not another issue tracker. Not a heavy
 portfolio suite. One board so a PM, tech lead, or executive can open
 it and see{' '}
 <strong className="text-zinc-800 font-medium">where we are, what we are doing next, and what we are doing later</strong>.
 The point is clearer decisions and less time spent restating the same narrative.
 </p>
 </div>
 ...
 outcome context. No issue types, sprint setup, or initiative
 trees to maintain. Delivery stays in your tracker.
 </p>
 </div>
 <div className="bg-white border border-zinc-200 rounded-xl p-6">
 <p className="text-xs font-semibold uppercase tracking-wider text-zinc-400 mb-2">
 ...
 visible. Stakeholder updates come from the board, so you are not
 rebuilding the story from scratch each quarter.
 </p>
 </div>
 </div>
 </div>
 ...
 sprints. Columns answer <em>what we choose</em>, not a schedule.
 Optional horizons and target dates add soft timing when you need it.
 </p>
 ...
 <p className="text-sm text-zinc-600 leading-relaxed">
 The short list capacity is on right now. Not &quot;due this Friday&quot;,
 but <em>chosen</em> for focus. Leadership should scan Now and know
 where product attention is.
 </p>
 </div>
 <div className="border border-zinc-200 rounded-xl p-5 bg-white">
 ...
 <p className="text-sm text-zinc-600 leading-relaxed">
 Ready to pull forward when capacity opens, not scheduled into a
 fictional sprint. Drag here when Now is full. Keeps the pipeline
 ...
 <p className="text-sm text-zinc-600 leading-relaxed">
 Visible on purpose, not a dumping ground. Later means we said no
 for now. That honesty stops every request from becoming a silent
 commitment.
 </p>
 </div>
 </div>
 ...
 Open one board. See priorities, owners, and evidence. Read a short
 Update (progress, risks, asks) instead of rebuilding slides.
 Kelly is for decisions and alignment, not delivery tracking.
 Ship dates and capacity stay in Linear or Jira.
 </p>
 ...
 <p className="text-sm text-zinc-600 leading-relaxed mb-3">
 Optional Goals hold outcome context (why this quarter matters).
 Items are the bets that might move those outcomes. That is
 directional alignment, not a rigid KR cascade. For agile teams,
 Kelly is the shared priority board; sprints and tickets stay in
 the delivery tool.
 </p>
 <p className="text-xs text-zinc-500">
 ...
 Put requests and hunches into Ideas. Nothing hits the roadmap
 until you promote it. Simple triage, without engineering
 workflow setup.
 </p>
 </div>
 </div>
 ...
 priorities change, not when a sprint ends. Avoids the endless
 status lists common in heavy PMO tools.
 </p>
 </div>
 </div>
 <div className="flex gap-4">
 ...
 <p className="text-sm text-zinc-600 mt-1 leading-relaxed">
 Interviews, support themes, and sales notes live on the Item.
 When someone asks why this is prioritized, the answer is on the
 card, not buried in Notion or Slack.
 </p>
 </div>
 </div>
 <div className="flex gap-4">
 ...
 <div>
 <h3 className="font-medium">Write a short status update</h3>
 <p className="text-sm text-zinc-600 mt-1 leading-relaxed">
 Progress, risks, next steps, and asks. Enough for leadership
 without another deck rebuild.
 </p>
 </div>
 </div>
 </div>
 ...
 Linear and Jira are strong at execution. Kelly covers the decision
 work PMs usually do in slides: prioritize, attach evidence, align
 the team, brief leadership. It is not another issue tracker. See also{' '}
 ...
 {[
 ['Built from the middle', 'Years between delivery trackers and executive decks left a gap: a simple view of Now, Next, and Later that supports real decisions.'],
 ['Priority over process', 'Locked Now / Next / Later beats infinite workflows. Less configuration, clearer shared language.'],
 ['Evidence on the work', 'Feedback lives on the Item so the reason for the priority does not drift into a separate wiki or Slack thread.'],
 ['Delivery stays elsewhere', 'Shared boards and owners keep the product group aligned. Linear and Jira remain the system of record for execution.'],
 ].map(([t, d]) => (
